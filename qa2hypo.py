                ...
                if corenlp:
                    ...
                    # how [adj]
                        ...
                        # need change of word order
                            ...
                            # replace [how many] and [how much] with the answer
                            if 'many' in question_rear[s_wh+3:s_wh+9] or 'much' in question_rear[s_wh+3:s_wh+9]:
                                s_wh += 5 
                            ...
                            if s_does == e_does:
                                # [be]
                                if e_vp == None:
                                    hypo = replace(strip_nonalnum_re(question_rear), e_np, e_np, " "+aux_be+" "+ans+" "+question_rear[s_wh+3:s_aux])
                                # [will]
                                else:
                                    hypo = replace(strip_nonalnum_re(question_rear), e_vp, e_vp, " "+ans+" "+question_rear[s_wh+3:s_aux])
